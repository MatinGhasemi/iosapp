        ...
        <div>
            <div className="px-5 py-10">
                <div className="flex justify-between gap-4">
                    <div className="w-full"><input type="text" className="bg-backgroundTransparent placeholder:px-4 h-14 w-full rounded-xl" placeholder="search" /></div>
                ...
                <div className="mt-6 space-y-4">
                    {messages.map((message,i)=>{
                        ...
                        <div className="flex items-center gap-4" key={i}>
                            <div className={`${message.bg} min-w-16 h-16 rounded-full flex justify-center items-center`}>{message.Avatar}</div>
